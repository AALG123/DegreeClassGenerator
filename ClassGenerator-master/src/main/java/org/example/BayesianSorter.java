...
public class BayesianSorter {
    ...
    public String getRankedClasses(Map<String, List<ClassInfo>> subjectClassesMap, String classNumber) {
        ...
        // Sort the classes in descending order of their ranking
        rankedClasses.sort(Comparator.comparing(ClassInfo::getRankingClass).reversed());

        StringBuilder results = new StringBuilder();
        for (ClassInfo rankClass: rankedClasses) {
            results.append(rankClass).append("\n");
        }
